...
function PipelineA() {
  return (
    <div className="grid gap-3">
      ...
      <Arrow />
      <Node
        title="Agreed split applied"
        body="Shop keeps its portion. Your share is remitted to you."
      />
      ...
      <Node
        title="Expenses"
        body="Tools, supplies, education, software, shop-related costs you pay directly, etc."
      />
      <Arrow />
      <Node
...
function PipelineB() {
  return (
    <div className="grid gap-3">
      ...
      <Arrow />
      <Node
        title="Payment collected by you"
        body="Clients pay you directly. You collect gross income."
      />
      <Arrow />
      <Node
        title="Professional business (Individual or LLC)"
        body="Income lands in your personal or business container."
      />
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
...
export default function IncomePipelinePage() {
  ...
  const structure: IncomeStructure = useMemo(() => resolveIncomeStructure(profile), [profile]);
  ...
  return (
    <div className="mx-auto w-full max-w-3xl">
      <div className="mb-6 flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-700">
            View-only preview. This diagram explains money flow—education only.
          </p>
        ...
        <div className="flex gap-2">
          ...
          <Link
            ...
            title="(placeholder page for now)"
          >
            Unlock ($59.99)
          </Link>
        </div>
      ...
      <div className="mt-6 rounded-xl border bg-white p-4 text-sm text-gray-700">
        ...
        collected can change your recordkeeping, but it doesn’t automatically change your
        classification.
      </div>
    </div>
  );
